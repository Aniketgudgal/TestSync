...
@WebServlet("/studenExamScheduleCompleted")
public class StudenExamScheduleCompleted extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(id.isPresent())
		{
			...
			Optional<List<Object[]>> o = ss.getExamScheduleInfoCompleted(id.get());
			if(o.isPresent())
			{
				...
				{
					out.println("<tr>");
					out.println("<td colspan = '10'>No Data Present</td>");
					out.println("</tr>");
				}
				out.println("</tbody>");
				out.println("</table>");
